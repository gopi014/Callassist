...
/* JavaScript content from js/auth/BonD.js in folder common */
/* ***************************************************************** */
/*                                                                   */
/* IBM Confidential                                                  */
/*                                                                   */
...
var BonD = {
		 ...
		 */
		appServer: {
			host: "http://9.121.206.90:10080", // "https://lmc1.watson.ibm.com:15010" ,//"http://9.122.28.132:10080",
			context: "/RoamAssist/",
//			context: "/app/bond/",
		 ...
		 */
		webServer: {
			host: "http://9.121.206.90:10080",//"http://9.122.28.132:10080",
			context: "/RoamAssist/",
			path: "invoke?adapter=bluePageLoginAdapter&procedure=checkSession&parameters=[]"
		},
		/**
		...
		deviceBackbutton : function() {
			...
			if (activePage == 'do-dont') {
				
				 WL.SimpleDialog.show(
				            "Quit application", 
				            "Are you sure?", 
				            [
				             {text: "Yes", handler: function() { navigator.app.exitApp();}},
